...
########################################################################################################################################
    ...
    },
    {
        ...
        "trial_index": "58.0",
        "drug": "180.0",
        "s1": "224.6153846153846",
        "s2": "0.0",
        "s3": "0.0",
        "s4": "0.0",
        "s5": "0.0",
        "s6": "0.0",
        "s7": "95.38461538461539",
        "s8": "0.0",
        "dmso": "0.0",
        "water": "679.9999999999999"
    },
    {
        "": "2",
        "trial_index": "59.0",
...
################################################################################################################################################
    ...
    def make_exp(current_drug_well, current_surfactant_well, next_plate_well):
        ...
        pipette_high.flow_rate.dispense = 50
        pipette_high.transfer(270, deepplate[current_surfactant_well], plate[next_plate_well], new_tip='never', air_gap= 10) #do air gap 50 for 1000uL tip
    ...
    plate_on_hs(labware_to_shake=plate, time=25, speed=1000, new_location='D1') # time in minutes, speed in rpm
