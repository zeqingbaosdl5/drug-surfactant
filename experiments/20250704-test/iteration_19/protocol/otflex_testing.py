...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def plate_on_hs_2(labware_to_shake, time_1, speed_1, time_3, new_location):  #only use when plate is not already on hs_adapter
    #def hs(time, speed):
...
################################################################################################################################################
    ...
    plate_on_hs_2(labware_to_shake=plate, time_1=1, speed_1=1000, time_3=1, new_location='D1') # time in minutes, speed in rpm
