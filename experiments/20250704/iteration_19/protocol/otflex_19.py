...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def plate_on_hs_2(labware_to_shake, time_1, speed_1, time_2, speed_2,time_3, speed_3, time_4, speed_4, new_location):  #only use when plate is not already on hs_adapter
    #def hs(time, speed):
...
########################################################################################################################################
    data = [
    {
        ...
        "drug": "360.0",
        "s1": "0.0",
        "s2": "410.42345276872965",
        "s3": "0.0",
        "s4": "28.729641693811075",
        "s5": "0.0",
        "s6": "410.42345276872965",
        "s7": "410.42345276872965",
        "s8": "0.0",
        "dmso": "0.0",
        "water": "740.0"
    },
    {
        ...
        "drug": "360.0",
        "s1": "0.0",
        "s2": "56.000000000000014",
        "s3": "0.0",
        "s4": "56.000000000000014",
        "s5": "56.000000000000014",
        "s6": "56.000000000000014",
        "s7": "56.000000000000014",
        "s8": "0.0",
        "dmso": "0.0",
        "water": "1720.0"
    },
    {
        ...
        "drug": "360.0",
        "s1": "0.0",
        "s2": "494.0476190476191",
        "s3": "0.0",
        "s4": "177.85714285714286",
        "s5": "0.0",
        "s6": "494.0476190476191",
        "s7": "494.0476190476191",
        "s8": "0.0",
        "dmso": "0.0",
        "water": "339.9999999999999"
    }
]
########################################################################################################################################
################################################################################################################################################
    ...
    def make_exp(current_drug_well, current_surfactant_well, next_plate_well):
        ...
        replicate_wells = []
        for _ in range(6):  #Change this number to control the amount of replicates
        ...
        for well in replicate_wells:
            pipette_high.transfer(270, deepplate[current_surfactant_well], plate[well], new_tip='never', air_gap= 20) #do air gap 50 for 1000uL tip
    ...
    plate_on_hs_2(labware_to_shake=plate, time_1=10, speed_1=1000, time_2=20, speed_2=0,time_3=10, speed_3=1000, time_4=20, speed_4=0, new_location='D1') # time in minutes, speed in rpm
