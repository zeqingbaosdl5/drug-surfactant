...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def hs(labware_to_shake, time_1, speed_1, time_2, speed_2,time_3, speed_3, time_4, speed_4, orignial_location):  #only use when plate is not already on hs_adapter
    #def hs(time, speed):
...
################################################################################################################################################
    ...
    def make_exp(current_drug_well, current_surfactant_well, next_plate_well):
        ...
        pipette_high.flow_rate.dispense = 50
        pipette_high.transfer(270, deepplate[current_surfactant_well], plate[next_plate_well], new_tip='never', air_gap= 20) #do air gap 50 for 1000uL tip
    ...
    plate_on_hs(labware_to_shake=plate, time_1=10, speed_1=1000, time_2=20, speed_2=0,time_3=10, speed_3=1000, time_4=20, speed_4=0, new_location='D1') # time in minutes, speed in rpm
