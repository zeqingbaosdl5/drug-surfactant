...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def plate_on_hs_2(labware_to_shake, time_1, speed_1, time_2,time_3, speed_3, time_4,):  #only use when plate is not already on hs_adapter
    #def hs(time, speed):
...
########################################################################################################################################
    ...
    },
    {
        ...
        "drug": "180.0",
        "s1": "0.0",
        "s2": "321.71581769436995",
        "s3": "0.0",
        "s4": "0.0",
        "s5": "0.0",
        "s6": "321.71581769436995",
        "s7": "321.71581769436995",
        "s8": "234.85254691689008",
        "dmso": "0.0",
        "water": "0.0"
    }
]
...
################################################################################################################################################
    ...
    plate_on_hs_2(labware_to_shake=plate, time_1= 10, speed_1=1000, time_2=20, time_3=10, speed_3=1000, time_4=20 ) # time in minutes, speed in rpm
