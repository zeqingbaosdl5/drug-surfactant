...
########################################################################################################################################
    data = [
    {
        "": "0",
        "trial_index": "6.0",
        "drug": "88.79999999999998",
        "s1": "0.0",
        "s2": "0.0",
        "s3": "1.6920473773265652",
        "s4": "1.6920473773265652",
        "s5": "0.8798646362098139",
        "s6": "1.065989847715736",
        "s7": "1.6920473773265652",
        "s8": "1.6920473773265652",
        "s9": "1.2859560067681892",
        "dmso": "31.200000000000006",
        "water": "990.0"
    }
]
########################################################################################################################################
################################################################################################################################################
    ...
    def make_drug_or_surfactant(a_list, next_deepplate_well, row_of_data):
        ...
        if n == len(drug_list)-1 and last_drug_tip is not None and float(row_of_data['dmso']) != 0:
