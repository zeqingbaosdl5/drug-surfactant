...
########################################################################################################################################
    ...
    },
    {
        ...
        "drug": "180.0",
        "s1": "0.0",
        "s2": "140.2714932126697",
        "s3": "140.2714932126697",
        "s4": "0.0",
        "s5": "29.457013574660632",
        "s6": "0.0",
        "s7": "0.0",
        "s8": "0.0",
        "dmso": "0.0",
    ...
    },
    {
        ...
        "s3": "0.0",
        "s4": "0.0",
        "s5": "78.53658536585365",
        "s6": "0.0",
        "s7": "341.4634146341464",
        "s8": "0.0",
        "dmso": "0.0",
        "water": "580.0"
    }
...
################################################################################################################################################
    ...
    def make_exp(current_drug_well, current_surfactant_well, next_plate_well):
        ...
        pipette_high.flow_rate.dispense = 50
        pipette_high.transfer(270, deepplate[current_surfactant_well], plate[next_plate_well], new_tip='never', air_gap= 50)
