...
########################################################################################################################################
    ...
    },
    {
        ...
        "s1": "0.0",
        "s2": "0.0",
        "s3": "326.08695652173907",
        "s4": "0.0",
        "s5": "192.39130434782606",
        "s6": "326.08695652173907",
        "s7": "29.34782608695652",
        "s8": "326.08695652173907",
        "dmso": "0.0",
        "water": "0.0"
    }
]
...
################################################################################################################################################
    ...
    def make_exp(current_drug_well, current_surfactant_well, next_plate_well):
        ...
        for well in replicate_wells:
            pipette_high.transfer(270, deepplate[current_surfactant_well], plate[well], new_tip='never', air_gap= 30) #do air gap 50 for 1000uL tip
