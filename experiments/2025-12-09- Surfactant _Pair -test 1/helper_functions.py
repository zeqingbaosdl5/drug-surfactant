...
def optimizer_init():
    ...
    ax_client.create_experiment(
        ...
        parameters=[
            ...
            {"name": "surf_1_conc", "type": "range", "bounds": [1, 20], "value_type": "int"}, # made lowest be 1, max=20
            ...
            {"name": "surf_2_conc", "type": "range", "bounds": [1, 20], "value_type": "int"}, #made lowest be 1, max 20
