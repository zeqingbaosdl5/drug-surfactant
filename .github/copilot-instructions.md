...
- Use the following environment secrets: `COPILOT_MCP_HIVEMQ_HOST`, `COPILOT_MCP_HIVEMQ_USERNAME`, and `COPILOT_MCP_HIVEMQ_PASSWORD` for testing. Never echo or expose these, even in your logs
